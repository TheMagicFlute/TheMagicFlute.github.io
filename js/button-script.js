// cookies, save the background state.
// let isMoved = true;
...
function checkAndSetCookie() {
    var bgStatus = getCookie("bgStatus");
    if (bgStatus != "") {
        isMoved = bgStatus;
    }
    bgStatus = isMoved;
    if (bgStatus != "" && bgStatus != null) {
        setCookie("bgStatus", bgStatus, 30);
    }
    console.log("now bgStatus is " + bgStatus);
}
// function setCookie() {
//   var bgStatus = getCookie("bgStatus");
//   if (bgStatus != "") {
...
//   bgStatus = isMoved;
//   setCookie("bgStatus", bgStatus, 30);
//   console.log("now bgStatus: " + bgStatus);
// }
